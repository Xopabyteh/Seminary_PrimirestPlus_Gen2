...
const tryGetExistingImage = async (foodName) => {
    ...
    const imageRef = (0,firebase_storage__WEBPACK_IMPORTED_MODULE_1__.ref)(firebaseStorage, query);

    try {
        try {
            const url = await (0,firebase_storage__WEBPACK_IMPORTED_MODULE_1__.getDownloadURL)(imageRef)
